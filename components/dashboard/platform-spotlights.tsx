...
/**
 * Equal-weight platform entry points so all platforms are visible without scrolling past the full tool list.
 */
export function PlatformSpotlights() {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <Link
        href="/aws"
        className="group relative overflow-hidden rounded-xl border border-(--accent)/20 bg-[linear-gradient(145deg,var(--accent-muted),var(--bg-elevated)_70%)] p-5 shadow-sm transition-colors hover:border-(--accent)/35 sm:min-h-[140px]"
      >
        <div
        ...
        <div className="relative flex h-full flex-col">
          <div className="flex items-start gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-(--accent)/12">
              {/* AWS wordmark — vendor brand color exception */}
      ...
      <Link
        ...
        className="group relative overflow-hidden rounded-xl border border-(--border-hairline) bg-(--bg-field) bg-[linear-gradient(145deg,color-mix(in_oklab,var(--text-secondary)_7%,transparent),var(--bg-elevated)_68%)] p-5 shadow-sm transition-colors hover:border-(--text-secondary)/25 sm:min-h-[140px]"
      >
        <div
      ...
      {fly && (
        <Link
          href="/fly/overview"
          className="group relative overflow-hidden rounded-xl border border-[#7B36F6]/20 bg-[linear-gradient(145deg,rgba(123,54,246,0.08),var(--bg-elevated)_70%)] p-5 shadow-sm transition-colors hover:border-[#7B36F6]/35 sm:min-h-[140px]"
        >
          <div
            className="pointer-events-none absolute -right-8 -top-8 h-28 w-28 rounded-full bg-[#7B36F6]/10 blur-2xl"
            aria-hidden
          />
          <div className="relative flex h-full flex-col">
            <div className="flex items-start gap-3">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#7B36F6]/12">
                {/* Fly.io brand mark — vendor brand color exception */}
                <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#7B36F6"
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[11px] font-medium text-[#7B36F6]">
                  Fly.io
                </p>
                <p className="mt-1.5 text-sm leading-snug text-(--text-secondary)">
                  {fly.lead}
            ...
            <span className="mt-auto pt-4 text-sm font-semibold text-[#7B36F6] group-hover:underline">
              Fly overview →
            </span>
          </div>
        </Link>
